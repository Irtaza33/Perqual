...
<link rel="stylesheet" href="https://cdn.datatables.net/1.11.5/css/dataTables.bootstrap4.min.css"> <!-- Optional for Bootstrap styling -->
<div class="container-fluid">

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Library Details</h6>
        </div>
        <div class="card-body">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                                <a onclick="return checkdelete()" href="?delete=<?php echo $row['s_id']; ?>" class="btn btn-delete"><span class="fa fa-trash"></span></a>
                                                            <?php
                                                            }
                                                            ?>
                                                        </td>
...
if (isset($_POST['btn_sim'])) {
    ...
    $insert = mysqli_query($conn, "insert into library_title(t_name) VALUES('$s_name') ");
    echo "<script>window.location.href = 'library.php';</script>";
}
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                <div class="modal-body">
                    <input type="text" name="s_name" placeholder="Section" class="form-control" required><br>
                </div>
